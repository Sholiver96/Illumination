...
public class TileEntitySolarLensRenderer extends TileEntitySpecialRenderer<TileEntitySolarLens> {

    @Override
    public void render(TileEntitySolarLens te, double x, double y, double z, float partialTicks, int damage, float unknown) {
