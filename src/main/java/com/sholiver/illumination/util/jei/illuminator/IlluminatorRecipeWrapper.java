...
public class IlluminatorRecipeWrapper implements IRecipeWrapper {

    private final ItemStack itemInput;
    private final ItemStack dustInput;
    private final List<List<ItemStack>> inputs;
    private final ItemStack output;


    public IlluminatorRecipeWrapper(ItemStack itemInput, ItemStack dustInput, ItemStack output) {
        this.itemInput = itemInput;
        this.dustInput = dustInput;
        this.output = output;

        this.inputs = new ArrayList<>();
        inputs.add(Collections.singletonList(itemInput));
        inputs.add(Collections.singletonList(dustInput));
    }
    ...
    public void drawInfo(Minecraft minecraft, int recipeWidth, int recipeHeight, int mouseX, int mouseY) {
        IlluminatorRecipes recipes = IlluminatorRecipes.instance();
